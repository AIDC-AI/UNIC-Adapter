...
pipe = StableDiffusion3Pipeline.from_pretrained("/Path/to/your/local/stable-diffusion-3.5-medium/", torch_dtype=torch.float16)
...
adapter_sd = torch.load("./ckpts/sd3.5_medium_adapter.pth", map_location="cpu")
...
def get_samples():
    sample_list = [
        ...
        },
        {
            ...
            "save_path": "./examples/output_imgs/understand/0.png",
...
header = """
# UNIC-Adapter / Stable Diffusion 3.5 medium
    ...
    with gr.Blocks() as app:
        ...
        with gr.Row(equal_height=False):
            with gr.Column(variant="panel", elem_classes="inputPanel"):
                ...
                task = gr.Radio(
                    [("subject", "subject"), ("pixel", "pixel"), ("style", "style"), ("understand", "understand")],
                    label="Task",
                    value="subject",
                    elem_id="task",
                )
...
if __name__ == "__main__":
    create_app().launch(debug=True, share=False, server_port=3001, server_name="0.0.0.0")
